...
let handler = async function (m, { conn, text, args, usedPrefix, command }) {
    ...
    if (!name) return m.reply('☃️ Eʟ ɴᴏʍ𝗯𝗿𝗲 ɴᴏ ᴘᴜᴇᴅᴇ ᴇsᴛᴀʀ ᴠᴀᴄɪᴏ.')
    if (!age) return m.reply('❄️ Lᴀ ᴇᴅᴀᴅ ɴᴏ ᴘᴜᴇᴅᴇ ᴇsᴛᴀʀ ᴠᴀᴄɪ́ᴀ.')
  ...
  await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                thumbnailUrl: 'https://files.cloudkuimages.guru/images/snOwXfDF.jpg',
                mediaType: 1,
