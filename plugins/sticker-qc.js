...
const handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    if (args.length >= 1) {
        ...
        return conn.reply(m.chat, `\`🐦‍🔥 ᴏʏᴇ ᴏʏᴇ ɪɴɢʀᴇsᴀ ᴇʟ ᴛᴇxᴛᴏ ᴘᴀʀᴀ ᴄʀᴇᴀʀ ᴇʟ sᴛɪᴄᴋᴇʀ\``, m, rcanal)
    }

    if (!text) return conn.reply(m.chat, `\`🐦‍🔥 ᴏʏᴇ ᴏʏᴇ ɪɴɢʀᴇsᴀ ᴇʟ ᴛᴇxᴛᴏ ᴘᴀʀᴀ ᴄʀᴇᴀʀ ᴇʟ sᴛɪᴄᴋᴇʀ\``, m, rcanal)
    ...
    if (mishi.length > 30) return conn.reply(m.chat, `\`🗯️ ᴇʟ ᴛᴇxᴛᴏ ɴᴏ ᴘᴜᴇᴅᴇ ᴛᴇɴᴇʀ ᴍᴀ́s ᴅᴇ 30 ᴄᴀʀᴀᴄᴛᴇʀᴇs xᴅ\``, m, rcanal)
