...
await conn.reply(m.chat, `> ⚙️ Se ha eliminado a @${m.sender.split`@`[0]} del grupo por \`Anti-Link\`! No permitimos enlaces de ${isChannelLink ? 'canales' : 'otros grupos'}.`, null, { mentions: [m.sender] })
if (isBotAdmin) {
try {
